  ...
  Future<List<GasStation>> getNearbyStations({
    ...
    try {
      ...
      nearbyStations.sort((a, b) {
        final distanceA = _calculateDistance(a.latitude, a.longitude, latitude, longitude);
        final distanceB = _calculateDistance(b.latitude, b.longitude, latitude, longitude);
